...
struct Options
{
    ...
    //@{
    Double_t L, M, U, V, G;
    Double_t lengthtokpc, velocitytokms, masstosolarmass, energyperunitmass;
    //@}
    ///period (comove)
    Double_t p;
    ...
    //@{
    Double_t a,H,h, Omega_m, Omega_b, Omega_cdm, Omega_Lambda, Omega_r, Omega_nu, Omega_k, Omega_de, w_de, rhobg, virlevel, virBN98;
    int comove;
