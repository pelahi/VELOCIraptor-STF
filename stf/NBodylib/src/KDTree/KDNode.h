...
*/
    class Node
    {
        ...
        virtual void SetID(Int_t id){nid=id;}
        //@}
...
*/        
        ...
        virtual void FOFSearchCriterionPeriodic(Double_t rd, int cmp(Particle, Particle, Double_t *), Double_t *params, Int_t iGroup, Int_t nActive, Particle *bucket, Int_t *Group, Int_t *Len, Int_t *Head, Int_t *Tail, Int_t *Next, Int_t *BucketFlag, Int_t *Fifo, Int_t &iTail, Double_t* off, Double_t *period, Int_t target) = 0;*/
