...
///similar to above but does a full rerank based on all progenitors across time updating the reference and the new as necessary
void UpdateDescendantAcrossTimeUsingDescendantBasedProgenitorList(Int_t nhalos, DescendantData **&pdescenref, DescendantData *&pdedentemp, ProgenitorDataDescenBased *&pdescenprogen, int istep, Double_t meritlimit);
